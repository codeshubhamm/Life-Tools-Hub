...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <section id="tools" className="py-20 px-0 md:px-4">
        <div className="w-full md:container md:mx-auto md:max-w-7xl">
          <div className="w-full bg-white/90 rounded-none md:rounded-3xl shadow-2xl p-6 md:p-12 border-0 md:border border-gray-200 backdrop-blur-lg animate-fade-in flex flex-col items-center">
