...
import { Calendar, Download, Save, Plus, Trash2, ArrowLeft } from "lucide-react";
    ...
    <div className="min-h-screen bg-background relative">
      ...
      <div className="container mx-auto px-4 pt-6 pb-8 max-w-7xl">
        ...
        <div className="flex flex-col items-center justify-center mb-10 mt-2">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-2 text-center">Weekly Planner Generator</h1>
