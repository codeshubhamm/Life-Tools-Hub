      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-6">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-lavender rounded-full mb-4">
              <DollarSign className="h-8 w-8 text-gray-700" />
            </div>
            <h1 className="text-3xl md:text-4xl font-bold mb-4">Bill Splitter</h1>
