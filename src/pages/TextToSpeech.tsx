...
import { Volume2, Play, Pause, Square, Download, ArrowLeft } from "lucide-react";
      ...
      <div className="container mx-auto px-4 pt-6 pb-8 max-w-4xl">
        ...
        <div className="flex flex-col items-center justify-center mb-10 mt-2">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-blue-100 rounded-full shadow mb-4">
            <Volume2 className="h-10 w-10 text-gray-700" />
          </div>
          <h1 className="text-3xl md:text-4xl font-bold mb-2 text-center">Text to Speech</h1>
